...
import com.juntai.wisdom.im.chat_module.voip.singleCall.event.MsgEvent;
...
public abstract class SingleCallFragment extends Fragment {
    ...
    SingleCallActivity callSingleActivity;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        callSingleActivity = (SingleCallActivity) getActivity();
        if (callSingleActivity != null) {
